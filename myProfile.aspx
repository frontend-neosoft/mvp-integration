<%@ Page Language="C#" Async="true" AutoEventWireup="true" CodeFile="myprofile.aspx.cs" Inherits="myprofile" %>
...
<body>
    <form id="form1" runat="server">
        <%--<asp:HiddenField ID="hdnIndexop" runat="server" />--%>
        <asp:HiddenField ID="hdnPostIndex" Value="1" runat="server" />
        <div id="profileWrap" class="infinite-scroll">

            <div id="contentWrap">
                <%--<header class="profileHeader parallax-window" data-parallax="scroll" data-image-src="<%=hdnCoverPic.Value %>">--%>
                                ...
                                <div class="user-profile-info">
                                    <div class="user-followers">
                                        <ul>
                                            <li>
                                                <a href="#">
                                                    <%--<asp:Literal ID="literalFollowers" Text="0" runat="server"></asp:Literal>--%>
                                            ...
                                            <li>
                                                <a href="#">
                                                    <%--<asp:Literal ID="literalFollowing" Text="0" runat="server"></asp:Literal>--%>
                                    ...
                                    <div class="user-image">
                                        <a href="#">
                                            ...
                                            <%--<asp:Image ID="imgProfilePic" CssClass="img-circle" runat="server" />--%>
                                        </a>
                                        <h4>
                                        ...
                                        <!-- <div class="edit-profile-btn">
											<button class="btn btn-md btn-default" type="button">Edit Site &amp; Apps</button>
										</div> -->
                                    </div>
                                </div>
                                <div id="addPostWarp" class="pull-left text-center">
                                    <figure>
                                        <a href="#" data-toggle="modal" data-target="#newPostModal">
                                            ...
                                            <div class="newpost-text uppercase">
                                                New<br />
                                                <small>Post</small>
                                            </div>
                                        </a>
                ...
                <div id="content">
                    <div class="pull-up">
                        <div class="container">
                            <div class="margin-lr-15">
                                <div id="menu-tab" class="col-xs-12">
                                    <div id="my-tabs">

                                        <div id="my-tab-content" class="tab-content">
                                            <div class="tab-pane active" id="Results">
                                                <div class="result-content">
                                                    <ul id="result-tab" class="nav nav-tabs" data-tabs="tabs">
                                                        <li class="active"><a href="#All" data-toggle="tab">All</a></li>
                                                        <li><a href="#favorite" data-toggle="tab" id="favorite_tab"><i class="fa fa-heart" aria-hidden="true"></i></a></li>
                                                        <li><a href="#comment" data-toggle="tab" id="comment_tab"><i class="fa fa-comment" aria-hidden="true"></i></a></li>
                                                        <li><a href="#user" data-toggle="tab" id="user_tab"><i class="fa fa-user" aria-hidden="true"></i></a></li>
                                                    </ul>
                                                    <div id="result-tab-content" class="tab-content">
                                                        <div class="tab-pane active" id="All">
                                                            <ul class="notification-listing" id="all_notification_wrap">
                                                                <script type="text/x-handlebars-template" id="all_notifications">
                                                                    {{#each this}}
												            		{{#if notification_msg}}
												            		<li>
                                                                        <a href="#"><i class="fa {{icon}}" aria-hidden="true"></i>{{timestamp}} <span>{{author}}</span> {{notification_msg}}</a>
                                                                    </li>
                                                                    {{/if}}
													            	{{/each}}
                                                                </script>
                                                            </ul>
                                                            <div class="load-more-notification text-center">
                                                                <button class="btn btn-md btn-carmine" type="button">LOAD MORE</button>
                                                            </div>
                                                        </div>
                                                        <div class="tab-pane" id="favorite">
                                                            <ul class="notification-listing" id="favorite_notification_wrap">
                                                            </ul>
                                                        </div>
                                                        <div class="tab-pane" id="comment">
                                                            <ul class="notification-listing" id="comment_notification_wrap">
                                                            </ul>
                                                        </div>
                                                        <div class="tab-pane" id="user">
                                                            <ul class="notification-listing" id="user_notification_wrap">
                                                            </ul>
                                                        </div>
                                                    </div>
                                                </div>
